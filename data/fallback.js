...
const settings = {
    ...
    homeKeyAreas: [
        { title: 'Professional Courses', desc: 'Practical and career-focused courses designed to develop valuable professional skills.', icon: 'graduation' },
        { title: 'Business Services', desc: 'Reliable professional services tailored to meet individual and business requirements.', icon: 'briefcase' },
        { title: 'Expert Team', desc: 'Experienced professionals committed to providing quality guidance and support.', icon: 'team' },
        { title: 'Career Development', desc: 'Helping students and professionals develop skills for better career opportunities.', icon: 'rocket' },
    ],
    homeCoreValues: [
        { title: 'Integrity', desc: 'We believe in honesty and transparency.', icon: 'handshake' },
        { title: 'Excellence', desc: 'We continuously work to improve the quality of our services.', icon: 'star' },
        { title: 'Customer Focus', desc: 'Our clients and students remain at the center of our work.', icon: 'target' },
        { title: 'Growth', desc: 'We believe in continuous personal, professional, and organizational development.', icon: 'growth' },
        { title: 'Innovation', desc: 'We encourage modern ideas, technology, and new approaches.', icon: 'lightbulb' },
    ],
    homeServices: {
        eyebrow: 'Services',
